...
falls back to activating its app (P7.1), and prunes genuinely-dead windows (P7.2). Phase 6
(verification) in progress — V6.1 / V6.6 / V6.8 / V6.11 / V6.12 done. Left: V6.2–V6.5, V6.7, V6.9,
V6.10, and V6.13 / V6.14 for Phase 7.**
